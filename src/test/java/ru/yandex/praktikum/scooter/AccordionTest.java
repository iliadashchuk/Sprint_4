...
// Mandatory check of main page - accordion expanding.
...
public class AccordionTest extends BaseTest {
    ...
    public void expandAccordion(){
        ...
        scooterPage.clickQuestionInAccordion(index);
        boolean answerIsDisplayed = scooterPage.answerIsDisplayedInAccordion(answer);
